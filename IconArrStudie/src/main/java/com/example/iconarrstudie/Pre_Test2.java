 ...
 */
public class Pre_Test2 extends Activity {
    private final static String TAG = Pre_Test2.class.getSimpleName();
    private int selected_screen;

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.i(TAG, "pre_test2 started!");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pre_test2);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i1 = new Intent(Pre_Test2.this, Test2_pverbrauch.class);
