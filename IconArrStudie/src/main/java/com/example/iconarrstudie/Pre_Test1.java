 ...
 */
public class Pre_Test1 extends Activity {
    private final static String TAG = Pre_Test1.class.getSimpleName();
    private int selected_screen;

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.i(TAG, "pre_test1 started!");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pre_test1);
